...
class ArbolitoUtils {
    ...
    const ARBOLITO_CUENTA_BAPRO_CTACTE = 2;

	const ARBOLITO_CONCEPTO_GASTO_VARIOS = 1;

	const ARBOLITO_CONCEPTO_MOVIMIENTO_GASTO= 2;
	const ARBOLITO_CONCEPTO_MOVIMIENTO_ANULACIONGASTO= 3;
	const ARBOLITO_CONCEPTO_MOVIMIENTO_VENTA= 4;
	const ARBOLITO_CONCEPTO_MOVIMIENTO_ANULACIONVENTA= 5;
	const ARBOLITO_CONCEPTO_MOVIMIENTO_PAGO= 6;
	const ARBOLITO_CONCEPTO_MOVIMIENTO_DEVOLUCION= 7;
	const ARBOLITO_CONCEPTO_MOVIMIENTO_ACTUALIZACION= 8;
	const ARBOLITO_CONCEPTO_MOVIMIENTO_PEDIDO= 9;
	const ARBOLITO_CONCEPTO_MOVIMIENTO_ANULACIONPEDIDO= 10;
    const ARBOLITO_CONCEPTO_MOVIMIENTO_RETIRO_EFECTIVO= 11;
    const ARBOLITO_CONCEPTO_MOVIMIENTO_ANULACION_RETIRO_EFECTIVO= 12;
    const ARBOLITO_CONCEPTO_MOVIMIENTO_TRANSFERENCIA= 13;
    const ARBOLITO_CONCEPTO_MOVIMIENTO_ANULACION_TRANSFERENCIA= 14;



	const ARBOLITO_CUENTA_UNICA = 1;

	const ARBOLITO_CAJA_DEFAULT = 1;

	const ARBOLITO_CLIENTE_DEFAULT = 1;

	const ARBOLITO_PROVEEDOR_DEFAULT = 1;

	const ARBOLITO_ID_DOLAR = 1;
	const ARBOLITO_ID_PORCENTAJE_PRECIO_LISTA = 2;

	const ARBOLITO_TIPO_PRODUCTO_DEFAULT = 21;
	const ARBOLITO_MARCA_PRODUCTO_DEFAULT = 24;
	...
	public static function sendMailPop($nameTo, $to, $subject, $msg, $attachs) {
		...
		/*$libsHome= ArbolitoConfig::getInstance()->getLibsPath();
		...
		if( ArbolitoConfig::TEST_MODE ){
			//me los envÃ­o todos a mi en test
			$to = ArbolitoConfig::TEST_MAIL_TO;
		}
		...
		$mail->Host = ArbolitoConfig::POP_MAIL_HOST;
		//Set the SMTP port number - likely to be 25, 465 or 587
		$mail->Port = ArbolitoConfig::POP_MAIL_PORT;
		$mail->SMTPSecure = ArbolitoConfig::POP_MAIL_SMTP_SECURE;
		//Whether to use SMTP authentication
		$mail->SMTPAuth = true;
		//Username to use for SMTP authentication
		$mail->Username = ArbolitoConfig::POP_MAIL_USERNAME;
		//Password to use for SMTP authentication
		$mail->Password = ArbolitoConfig::POP_MAIL_PASSWORD;

		//Set who the message is to be sent from
		$mail->setFrom(ArbolitoConfig::MAIL_FROM, ArbolitoConfig::MAIL_FROM_NAME);
		//Set an alternative reply-to address
		$mail->addReplyTo(ArbolitoConfig::MAIL_FROM, ArbolitoConfig::MAIL_FROM_NAME);
	...
	public static function sendMail($nameTo, $to, $subject, $msg, $attachs) {
		...
		if (ArbolitoConfig::MAIL_ENVIO_POP)
	...
	public static function getConceptoGastoVarios(){
		...
		return ServiceFactory::getConceptoGastoService()->get( self::ARBOLITO_CONCEPTO_GASTO_VARIOS );
	}

	public static function getConceptoMovimientoGasto(){

		return ServiceFactory::getConceptoMovimientoService()->get( self::ARBOLITO_CONCEPTO_MOVIMIENTO_GASTO );
	}

	public static function getConceptoMovimientoAnulacionGasto(){

		return ServiceFactory::getConceptoMovimientoService()->get( self::ARBOLITO_CONCEPTO_MOVIMIENTO_ANULACIONGASTO );
	}

	public static function getConceptoMovimientoPedido(){

		return ServiceFactory::getConceptoMovimientoService()->get( self::ARBOLITO_CONCEPTO_MOVIMIENTO_PEDIDO );
	}

	public static function getConceptoMovimientoAnulacionPedido(){

		return ServiceFactory::getConceptoMovimientoService()->get( self::ARBOLITO_CONCEPTO_MOVIMIENTO_ANULACIONPEDIDO );
	}

	public static function getConceptoMovimientoVenta(){

		return ServiceFactory::getConceptoMovimientoService()->get( self::ARBOLITO_CONCEPTO_MOVIMIENTO_VENTA );
	}

	public static function getConceptoMovimientoAnulacionVenta(){

		return ServiceFactory::getConceptoMovimientoService()->get( self::ARBOLITO_CONCEPTO_MOVIMIENTO_ANULACIONVENTA );
	}

	public static function getConceptoMovimientoPago(){

		return ServiceFactory::getConceptoMovimientoService()->get( self::ARBOLITO_CONCEPTO_MOVIMIENTO_PAGO);
	}

	public static function getConceptoMovimientoDevolucion(){

		return ServiceFactory::getConceptoMovimientoService()->get( self::ARBOLITO_CONCEPTO_MOVIMIENTO_DEVOLUCION);
	}

	public static function getConceptoMovimientoActualizacion(){

		return ServiceFactory::getConceptoMovimientoService()->get( self::ARBOLITO_CONCEPTO_MOVIMIENTO_ACTUALIZACION);
	}

    public static function getConceptoMovimientoTransferencia(){

        return ServiceFactory::getConceptoMovimientoService()->get( self::ARBOLITO_CONCEPTO_MOVIMIENTO_TRANSFERENCIA );
    }

    public static function getConceptoMovimientoAnulacionTransferencia(){

        return ServiceFactory::getConceptoMovimientoService()->get( self::ARBOLITO_CONCEPTO_MOVIMIENTO_ANULACION_TRANSFERENCIA );
    }

    public static function getConceptoMovimientoRetiroEfectivo(){

        return ServiceFactory::getConceptoMovimientoService()->get( self::ARBOLITO_CONCEPTO_MOVIMIENTO_RETIRO_EFECTIVO );
    }

    public static function getConceptoMovimientoAnulacionRetiroEfectivo(){

        return ServiceFactory::getConceptoMovimientoService()->get( self::ARBOLITO_CONCEPTO_MOVIMIENTO_ANULACION_RETIRO_EFECTIVO );
    }


	public static function getCuentaUnica(){

		return ServiceFactory::getCuentaService()->get( self::ARBOLITO_CUENTA_UNICA );
	}

	public static function getCajaDeafault(){

		return ServiceFactory::getCajaService()->get( self::ARBOLITO_CAJA_DEFAULT );
	}

	public static function getPrecioDolar(){

		return ServiceFactory::getParametroService()->get( self::ARBOLITO_ID_DOLAR );
	}

	public static function getPorcentajePrecioLista(){

		return ServiceFactory::getParametroService()->get( self::ARBOLITO_ID_PORCENTAJE_PRECIO_LISTA );
	}

	public static function getTipoProductoDefault(){

		return ServiceFactory::getTipoProductoService()->get( self::ARBOLITO_TIPO_PRODUCTO_DEFAULT );
	}

	public static function getMarcaProductoDefault(){

		return ServiceFactory::getMarcaProductoService()->get( self::ARBOLITO_MARCA_PRODUCTO_DEFAULT );
	}

	public static function getClienteDefault(){

		return ServiceFactory::getClienteService()->get( self::ARBOLITO_CLIENTE_DEFAULT );
	}

	public static function getProveedorDefault(){

		return ServiceFactory::getProveedorService()->get( self::ARBOLITO_PROVEEDOR_DEFAULT );
	}

    public static function getCuentaBAPROCtaCte(){

        return ServiceFactory::getBancoService()->get( self::ARBOLITO_CUENTA_BAPRO_CTACTE );
    }
}
