 ...
 */
class Producto extends \Arbolito\Core\model\Producto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Arbolito\\Core\\model\\Producto' . "\0" . 'fecha', '' . "\0" . 'Arbolito\\Core\\model\\Producto' . "\0" . 'tipoProducto', '' . "\0" . 'Arbolito\\Core\\model\\Producto' . "\0" . 'marcaProducto', '' . "\0" . 'Arbolito\\Core\\model\\Producto' . "\0" . 'nombre', '' . "\0" . 'Arbolito\\Core\\model\\Producto' . "\0" . 'descripcion', '' . "\0" . 'Arbolito\\Core\\model\\Producto' . "\0" . 'iva', '' . "\0" . 'Arbolito\\Core\\model\\Producto' . "\0" . 'stock', '' . "\0" . 'Arbolito\\Core\\model\\Producto' . "\0" . 'stockMinimo', '' . "\0" . 'Arbolito\\Core\\model\\Producto' . "\0" . 'precioLista', '' . "\0" . 'Arbolito\\Core\\model\\Producto' . "\0" . 'precioEfectivo', '' . "\0" . 'Arbolito\\Core\\model\\Producto' . "\0" . 'costo', '' . "\0" . 'Arbolito\\Core\\model\\Producto' . "\0" . 'porcentajeGanancia', '' . "\0" . 'Arbolito\\Core\\model\\Producto' . "\0" . 'vencimiento', '' . "\0" . 'Arbolito\\Core\\model\\Producto' . "\0" . 'cantidad'];
        }
