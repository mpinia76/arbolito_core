 ...
 */
class Transferencia extends \Arbolito\Core\model\Transferencia implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Arbolito\\Core\\model\\Transferencia' . "\0" . 'fechaHora', '' . "\0" . 'Arbolito\\Core\\model\\Transferencia' . "\0" . 'monto', '' . "\0" . 'Arbolito\\Core\\model\\Transferencia' . "\0" . 'estado', '' . "\0" . 'Arbolito\\Core\\model\\Transferencia' . "\0" . 'observaciones', '' . "\0" . 'Arbolito\\Core\\model\\Transferencia' . "\0" . 'origen', '' . "\0" . 'Arbolito\\Core\\model\\Transferencia' . "\0" . 'destino', '' . "\0" . 'Arbolito\\Core\\model\\Transferencia' . "\0" . 'user'];
        }
