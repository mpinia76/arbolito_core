 ...
 */
class ConceptoGasto extends \Arbolito\Core\model\ConceptoGasto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Arbolito\\Core\\model\\ConceptoGasto' . "\0" . 'nombre'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ConceptoGasto $proxy) {
