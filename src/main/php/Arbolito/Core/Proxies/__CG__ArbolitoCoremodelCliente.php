...
namespace arbolito\Core\Proxies\__CG__\Arbolito\Core\model;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Cliente extends \Arbolito\Core\model\Cliente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Arbolito\\Core\\model\\Cliente' . "\0" . 'nombre', '' . "\0" . 'Arbolito\\Core\\model\\Cliente' . "\0" . 'nroSocio', '' . "\0" . 'Arbolito\\Core\\model\\Cliente' . "\0" . 'tipoCliente', '' . "\0" . 'Arbolito\\Core\\model\\Cliente' . "\0" . 'tipoDocumento', '' . "\0" . 'Arbolito\\Core\\model\\Cliente' . "\0" . 'documento', '' . "\0" . 'Arbolito\\Core\\model\\Cliente' . "\0" . 'cuit', '' . "\0" . 'Arbolito\\Core\\model\\Cliente' . "\0" . 'sexo', '' . "\0" . 'Arbolito\\Core\\model\\Cliente' . "\0" . 'mail', '' . "\0" . 'Arbolito\\Core\\model\\Cliente' . "\0" . 'telefono', '' . "\0" . 'Arbolito\\Core\\model\\Cliente' . "\0" . 'celular', '' . "\0" . 'Arbolito\\Core\\model\\Cliente' . "\0" . 'laboral', '' . "\0" . 'Arbolito\\Core\\model\\Cliente' . "\0" . 'localidad', '' . "\0" . 'Arbolito\\Core\\model\\Cliente' . "\0" . 'direccion', '' . "\0" . 'Arbolito\\Core\\model\\Cliente' . "\0" . 'nacimiento', '' . "\0" . 'Arbolito\\Core\\model\\Cliente' . "\0" . 'fecha', '' . "\0" . 'Arbolito\\Core\\model\\Cliente' . "\0" . 'ultModificacion', '' . "\0" . 'Arbolito\\Core\\model\\Cliente' . "\0" . 'observaciones', '' . "\0" . 'Arbolito\\Core\\model\\Cliente' . "\0" . 'cuentaCorriente'];
        }
    ...
    public function getNroSocio()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNroSocio', []);

        return parent::getNroSocio();
    }
    ...
    public function setNroSocio($nroSocio)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNroSocio', [$nroSocio]);

        return parent::setNroSocio($nroSocio);
    }
