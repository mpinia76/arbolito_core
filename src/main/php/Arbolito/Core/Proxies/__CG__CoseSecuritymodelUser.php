...
namespace arbolito\Core\Proxies\__CG__\Cose\Security\model;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \Cose\Security\model\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Cose\\Security\\model\\User' . "\0" . 'username', '' . "\0" . 'Cose\\Security\\model\\User' . "\0" . 'password', '' . "\0" . 'Cose\\Security\\model\\User' . "\0" . 'name', '' . "\0" . 'Cose\\Security\\model\\User' . "\0" . 'email', '' . "\0" . 'Cose\\Security\\model\\User' . "\0" . 'groups', '' . "\0" . 'Cose\\Security\\model\\User' . "\0" . 'lastLogin', '' . "\0" . 'Cose\\Security\\model\\User' . "\0" . 'loginFrom', '' . "\0" . 'Cose\\Security\\model\\User' . "\0" . 'logged', '' . "\0" . 'Cose\\Security\\model\\User' . "\0" . 'lastname'];
        }
     ...
     * {@inheritDoc}
     */
    public function hasUsergroup(\Cose\Security\model\UserGroup $group)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'hasUsergroup', [$group]);

        return parent::hasUsergroup($group);
    }
    ...
    public function hasUsergroupByName($name)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'hasUsergroupByName', [$name]);

        return parent::hasUsergroupByName($name);
    }
    ...
    public function hasPermissionByName($name)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'hasPermissionByName', [$name]);
    ...
    public function getLoginFrom()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLoginFrom', []);
    ...
    public function setLoginFrom($loginFrom)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLoginFrom', [$loginFrom]);
