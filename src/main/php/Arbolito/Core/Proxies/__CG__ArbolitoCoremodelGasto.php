 ...
 */
class Gasto extends \Arbolito\Core\model\Gasto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Arbolito\\Core\\model\\Gasto' . "\0" . 'fecha', '' . "\0" . 'Arbolito\\Core\\model\\Gasto' . "\0" . 'fechaVencimiento', '' . "\0" . 'Arbolito\\Core\\model\\Gasto' . "\0" . 'monto', '' . "\0" . 'Arbolito\\Core\\model\\Gasto' . "\0" . 'estado', '' . "\0" . 'Arbolito\\Core\\model\\Gasto' . "\0" . 'observaciones', '' . "\0" . 'Arbolito\\Core\\model\\Gasto' . "\0" . 'user', '' . "\0" . 'Arbolito\\Core\\model\\Gasto' . "\0" . 'concepto'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Gasto $proxy) {
