 ...
 */
class TipoCliente extends \Arbolito\Core\model\TipoCliente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Arbolito\\Core\\model\\TipoCliente' . "\0" . 'nombre', '' . "\0" . 'Arbolito\\Core\\model\\TipoCliente' . "\0" . 'pagaCuota'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TipoCliente $proxy) {
    ...
    public function getPagaCuota()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPagaCuota', []);

        return parent::getPagaCuota();
    }
    ...
    public function setPagaCuota($pagaCuota)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPagaCuota', [$pagaCuota]);

        return parent::setPagaCuota($pagaCuota);
    }
