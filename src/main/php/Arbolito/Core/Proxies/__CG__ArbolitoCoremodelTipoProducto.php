 ...
 */
class TipoProducto extends \Arbolito\Core\model\TipoProducto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Arbolito\\Core\\model\\TipoProducto' . "\0" . 'nombre', '' . "\0" . 'Arbolito\\Core\\model\\TipoProducto' . "\0" . 'stock'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TipoProducto $proxy) {
