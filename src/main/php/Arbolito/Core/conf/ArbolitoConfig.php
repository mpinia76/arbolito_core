...
class ArbolitoConfig {
	...
	private $appPathCore = "D:/Documents/Mis Webs/arbolito_core";

	const PROXIES_NAMESPACE="arbolito\\Core\\Proxies";
	const PROXIES_PATH=  "/Proxies";


	const TEST_MODE = true;
	const MAIL_FROM_NAME = "Arbolito Tanto";
	const MAIL_FROM = "arbolitotanto@gmail.com";
