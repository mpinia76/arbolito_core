...
use Arbolito\Core\dao\IMovimientoPagoDAO;

use Arbolito\Core\model\ConceptoMovimiento;

use Arbolito\Core\dao\IConceptoMovimientoDAO;
 ...
 *
 */
class MovimientoPagoDoctrineDAO extends CrudDAO implements IMovimientoPagoDAO{

	protected function getClazz(){
		return get_class( new MovimientoPago() );
	}
