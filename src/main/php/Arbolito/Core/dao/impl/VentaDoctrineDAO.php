...
use Arbolito\Core\dao\IVentaDAO;
...
class VentaDoctrineDAO extends CrudDAO implements IVentaDAO{
	...
	protected function enhanceQueryBuild(QueryBuilder $queryBuilder, ICriteria $criteria){
        ...
        $nroComprobante = $criteria->getNroComprobante();
        if( !empty($nroComprobante) ){
            $queryBuilder->andWhere("upper(v.nroComprobante)  like :nroComprobante");
            $queryBuilder->setParameter( "nroComprobante" , "%$nroComprobante%" );
        }
