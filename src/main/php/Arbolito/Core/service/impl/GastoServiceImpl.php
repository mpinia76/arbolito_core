...
use Arbolito\Core\criteria\MovimientoGastoCriteria;

use Arbolito\Core\service\ServiceFactory;

use Arbolito\Core\utils\ArbolitoUtils;

use Arbolito\Core\model\MovimientoGasto;
...
use Arbolito\Core\service\IGastoService;
...
class GastoServiceImpl extends CrudService implements IGastoService {
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Arbolito/Core/service/Arbolito\Core\service.IGastoService::pagar()
	 */
	public function pagar(Gasto $gasto, Cuenta $cuenta, User $user){
		...
		$movimiento->setConcepto( ArbolitoUtils::getConceptoMovimientoGasto() );
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Arbolito/Core/service/Arbolito\Core\service.IGastoService::anular()
	 */
	public function anular(Gasto $gasto, User $user){
		...
		if( $gasto->getEstado() == EstadoGasto::Pagado ){
			...
			$contramovimiento->setConcepto( ArbolitoUtils::getConceptoMovimientoAnulacionGasto() );
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Arbolito/Core/service/Arbolito\Core\service.IGastoService::getGastosPorVencer()
	 */
