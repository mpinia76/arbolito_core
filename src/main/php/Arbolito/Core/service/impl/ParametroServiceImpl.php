...
use Arbolito\Core\service\IParametroService;
...
/**
 * servicio para Parametro
 *
 * @author Marcos
 * @since 16-07-2018
 *
 */
class ParametroServiceImpl extends CrudService implements IParametroService {


	protected function getDAO(){
		return DAOFactory::getParametroDAO();
	}
