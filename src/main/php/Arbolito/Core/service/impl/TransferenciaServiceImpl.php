...
use Arbolito\Core\criteria\MovimientoTransferenciaCriteria;

use Arbolito\Core\model\EstadoTransferencia;

use Arbolito\Core\service\ITransferenciaService;

use Arbolito\Core\model\Transferencia;

use Arbolito\Core\service\ServiceFactory;

use Arbolito\Core\model\MovimientoTransferencia;
...
class TransferenciaServiceImpl extends CrudService implements ITransferenciaService {
	...
	function add( $entity ){
		...
		if ($entity->getOrigen()) {
			...
			$movimiento->setConcepto( ArbolitoUtils::getConceptoMovimientoTransferencia() );
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Arbolito/Core/service/Arbolito\Core\service.ITransferenciaService::anular()
	 */
	public function anular(Transferencia $transferencia, User $user){
		...
		$contramovimiento->setConcepto( ArbolitoUtils::getConceptoMovimientoAnulacionTransferencia() );
