 ...
 * Cliente
 *
 * @Entity @Table(name="arbolito_cliente")
 *
 * @author Marcos
 */
...
class Cliente extends Entity{
    ...
    /**
     * @ManyToOne(targetEntity="Arbolito\Core\model\TipoCliente",cascade={"detach"})
     * @JoinColumn(name="tipoCliente_oid", referencedColumnName="oid")
     *
     * tipo de cliente del cliente
     **/
    private $tipoCliente;
	...
	/**
     * @ManyToOne(targetEntity="Arbolito\Core\model\Localidad",cascade={"detach"})
