 ...
 * Producto
 *
 * @Entity @Table(name="arbolito_producto")
 *
 * @author Marcos
 */
...
class Producto extends Entity{
    ...
    /**
     * @ManyToOne(targetEntity="Arbolito\Core\model\TipoProducto",cascade={"detach"})
    ...
    /**
     * @ManyToOne(targetEntity="Arbolito\Core\model\MarcaProducto",cascade={"detach"})
	...
	private $descripcion;
	 ...
	 /**
     * @ManyToOne(targetEntity="Arbolito\Core\model\Iva",cascade={"detach"})
	...
	{
		/*$parametroDolar = ArbolitoUtils::getPrecioDolar();
	    $parametroPorcentaje = ArbolitoUtils::getPorcentajePrecioLista();
