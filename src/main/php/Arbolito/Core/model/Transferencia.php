 ...
 * Transferencia
 *
 * Transferencia entre arbolito
 *
 * @Entity @Table(name="arbolito_transferencia")
 *
*  @author Marcos
 * @since 02-08-2018
 */
...
class Transferencia extends Entity{
	...
	public function __toString(){
		 return $this->getOrigen() . " -> " . $this->getDestino() . " : " . ArbolitoUtils::formatMontoToView( $this->getMonto() );
	}
